...
import { signUp, sendEmailVerification } from '../../store/actions/userActions'
    ...
    if (this.isValid()) {
      ...
      this.props
        ...
        .then(uid => {
          ...
          this.props.updateProfile(uid, newProfile)
          this.props.sendEmailVerification()
          this.props.history.push(this.state.returnUrl || '/account')
...
export default withStyles(styles)(
  withRouter(
    connect(
      null,
      { signUp, sendEmailVerification, success, updateProfile },
    )(SignUpPage),
  ),
)
